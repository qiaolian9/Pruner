...
def train_zero_shot(dataset, train_ratio, model_names, split_scheme, use_gpu, cur_fold):
    # Split dataset
    ...
    for name, model in zip(names, models):
        # Train the model
        filename = os.path.join(args.save_path, str(cur_fold), name + '_' + args.dataset[0].split('_')[-2] + '_{}_{}.pkl'.format(args.file_cnt, str(args.saveName)))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--models", type=str, default="pam")
    parser.add_argument("--seed", type=int, default=0)
    parser.add_argument("--save_path", type=str, default='./ckpt/k80/500')
    parser.add_argument("--file_cnt", type=int, default=0)
    parser.add_argument("--ratio", type=float, default=1.0)
    parser.add_argument("--select_cnt", type=int, default=0)
    ...
    for i in range(1, args.fold + 1):
        ...
        train_zero_shot(sub_dataset, args.train_ratio, args.models, args.split_scheme, args.use_gpu, i)
        del sub_dataset
