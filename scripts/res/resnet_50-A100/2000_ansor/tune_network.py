...
def get_tuning_option(tuning_args, target, num_tasks=None):
    ...
    print(n_trials if num_tasks == None else n_trials * num_tasks)
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--target", type=str, default='cuda -keys=cuda,gpu -arch=sm_75 -max_num_threads=1024\
    #                      -max_threads_per_block=1024 -registers_per_block=65536 -shared_memory_per_block=49152 -thread_warp_size=32')
    # parser.add_argument("--target", type=str, default='cuda -model=titanv')
